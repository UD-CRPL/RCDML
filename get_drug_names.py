...
data_path = "/Users/mf0082/Documents/MODEL/dataset/"
...
def get_drug_names(data_path, drug_family):
    ...
    drug_count = pd.read_excel(data_path + "aml/beatAML/variants_BeatAML.xlsx", sheet_name="Table S10-Drug Responses")
...
print("DRUGS IN FAMILY:")
print(family)

print("DRUGS NOT IN FAMILY:")
print(match)
